...
echo "Run command: az acr create --resource-group slbrg --name sogetislbdemo --sku Basic"
echo "`n"
echo "OUTPUT"
az acr create --resource-group slbrg --name sogetislbdemo --sku Basic
Write-Output "--------------------------------------------------------------------"
echo "`n"

echo "Login to Container Registry created"
echo "Run command: az acr login --name sogetislbdemo"
echo "`n"
echo "OUTPUT"
az acr login --name sogetislbdemo
Write-Output "--------------------------------------------------------------------"
echo "`n"